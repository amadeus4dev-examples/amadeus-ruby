...
require 'amadeus/namespaces/reference_data/locations/point_of_interests'
require 'amadeus/namespaces/reference_data/locations/point_of_interests/by_square'
