    ...
    class Shopping
      ...
      class Hotels < Amadeus::Client::Decorator
        ...
        def offers(offer_id = nil)
          Amadeus::Client::Shopping::Hotels::Offers.new(
        ...
        #
        # @return [Amadeus::Client::Shopping::Hotels::HotelOffers]
        # @example
        #   amadeus.shopping.hotels(123).hotel_offers
        #
        def hotel_offers
          Amadeus::Client::Shopping::Hotels::HotelOffers.new(client, @hotel_id)
        end
