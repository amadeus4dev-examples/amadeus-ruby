...
module Amadeus
  ...
  class Request
    ...
    # @return [Symbol]
    attr_reader :verb
    # The initialized bearer token. This will be nil if no +Amadeus:AccessToken+
    # was passed in
    # @return [String]
    ...
    #
    # @param [Amadeus::Client] client The Amadeus::Client that will make the API
    #   call
    ...
    # Build a new +Amadeus::Request+ with all the same argument as this request
    # and merging in the provided params to the existing ones.
    #
    ...
    def merge(params)
      ...
      Amadeus::Request.new(@client, @verb, @path, new_params, @access_token)
    end
